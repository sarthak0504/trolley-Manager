...
import { usePayments } from "../../src/store/PaymentsStore";
import { useTrolleys } from "../../src/store/TrolleyStore";
import AddPaymentModal from "../../src/components/AddPaymentModal";
import ManageRentCyclesModal from "../../src/components/ManageRentCyclesModal";
  ...
  const handleSavePayment = async (details) => {
    ...
    try {
      if (details.id) {
        ...
        await addPayment(id, { ...details, type: "manual" });
      }
